...
function ReviewCard({ review }: { review: UserReview }) {
  return (
    <div className="relative pt-[61px]">
      ...
      <div className="h-full rounded-[34px] bg-[rgba(0,88,100,0.06)] px-5 pb-5 pt-[70px]">
        <div className="mb-3 flex flex-col items-start gap-[2px]">
          <span className="text-[20px] font-medium leading-[25px] text-[#000000]">
            {review.name}
          </span>
          <span className="text-[16px] font-medium leading-[20px] text-[#005864]">
            {review.jobTitle}
          </span>
            ...
            <div className="mt-4 flex justify-end">
              <div className="flex h-12 w-[161px] items-center justify-between rounded-[24px] bg-[#F8F8F8] px-1">
                ...
                >
                  <ChevronRight
                    className={`h-5 w-5 ${
                      page === totalPages ? "text-[#005864]" : "text-white"
                    }`}
                    strokeWidth={2.5}
                  />
                </button>
