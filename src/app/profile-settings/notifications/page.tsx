...
import { useBrowserNotificationsEnabled } from "@/hooks/notifications/use-browser-notifications-enabled";
...
export default function NotificationsPage() {
  ...
  const {
    ...
    isSupported: isBrowserNotificationsSupported,
    isUpdating: isBrowserNotificationsUpdating,
          ...
          <div className="flex items-center justify-between rounded-[12px] bg-white px-4 py-3">
            <div>
              ...
              {!isBrowserNotificationsSupported ? (
                <p className="mt-1 text-[13px] leading-5 text-[rgba(24,24,24,0.55)]">
            ...
            <button
              ...
              disabled={
                !isBrowserNotificationsSupported ||
                isBrowserNotificationsUpdating ||
                browserNotificationPermission === "denied"
              }
              className="cursor-pointer disabled:cursor-not-allowed disabled:opacity-60"
            >
              <Toggle enabled={browserNotificationsEnabled} />
            </button>
          </div>
