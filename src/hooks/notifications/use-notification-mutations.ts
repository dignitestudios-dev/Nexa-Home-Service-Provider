...
function removeNotificationFromCache(
  ...
  queryClient.setQueryData<NotificationsResult>(NOTIFICATIONS_QUERY_KEY, (current) => {
...
export function useDeleteNotificationMutation() {
  ...
  return useMutation({
    ...
    onMutate: async (notificationId) => {
      ...
      const previousNotifications = queryClient.getQueryData<NotificationsResult>(
        NOTIFICATIONS_QUERY_KEY,
      );
      const previousCount = queryClient.getQueryData<number>(
        NOTIFICATIONS_COUNT_QUERY_KEY,
      ...
      return { previousNotifications, previousCount, id };
    },
